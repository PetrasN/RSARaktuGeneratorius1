...
public class MyKeyGenerator {
    ...
    public MyKeyGenerator(String password, String druska) {
    ...
    private void apskaiciuoti() {
        byte[] out = sekosGeneravimas(2048, password, druska);
    ...
    private byte[] sekosGeneravimas(int sekosIlgis, String password, String druska) {
        try {
            byte[] salt =druska.getBytes(Charset.forName("ASCII"));
